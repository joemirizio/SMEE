...
public class Scenario implements ActionListener {
    ...
    public void scenario1() {
        ...
        spot.setPosition(new Vector3f(0f, 10f, 0f));               // shine from camera loc
        spot.setDirection(new Vector3f(0, -1f, 0f));    // shine forward from camera loc
        this.addLight(spot); 
        ...
        spot1.setPosition(new Vector3f(0f, 10f, 10f));               // shine from camera loc
        spot1.setDirection(new Vector3f(0f, -1f, 0f));      // shine forward from camera loc
        this.addLight(spot1); 
        ...
        // Camera
        this.main_app.cam1.setVerticalFOV(20);
        this.main_app.cam1.setLocalTranslation(new Vector3f(-3f, 6f, 0f));
        this.main_app.cam1.lookAt(new Vector3f(0.3f,-0.4f,0.4f));
        
        this.main_app.cam2.setVerticalFOV(20);
        this.main_app.cam2.setLocalTranslation(new Vector3f(3f, 6f, 0f));		
        this.main_app.cam2.lookAt(new Vector3f(-0.4f, -0.7f, 0.55f));
    }
